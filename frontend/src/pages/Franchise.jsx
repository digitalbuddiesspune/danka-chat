      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-6 text-white/95 max-w-4xl mx-auto leading-relaxed font-light font-body">
            Love panipuri? Passionate about chaat? Turn that passion into a profitable business with <span className="font-bold font-body text-yellow-300">Danka</span>
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                <div className="text-3xl font-heading text-yellow-300 mb-2">{stat.number}</div>
      ...
      <section id="learn-more" className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-5xl mb-6 pb-1 bg-gradient-to-r from-gray-700 via-gray-600 to-yellow-500 text-transparent bg-clip-text font-heading">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                {/* Content */}
                <h3 className="text-xl font-bold font-heading mb-4 text-gray-900 group-hover:text-yellow-600 transition-colors duration-300">
                  {benefit.title}
                </h3>
     ...
     <OurRestaurant />
      ...
      <section className="py-24 px-4 relative overflow-hidden text-white" style={{ background: 'linear-gradient(to bottom, #000000, #1a0e06, #2b1205)' }}>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-4xl mb-8 text-white leading-tight font-heading">
            Ready to Start Your
            <br />
