    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white py-12 sm:py-16 md:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl lg:text-2xl mb-3 sm:mb-4 max-w-3xl mx-auto px-2"
          >
            Whether you want to own a Danka franchise, collaborate, or just share your love for chaat — our team is always happy to connect.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.4 }}
            className="text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto px-2"
          >
            Let's start something exciting together — because every great business begins with a great conversation!
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-800">Head Office:</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <p className="text-gray-600 font-semibold text-sm sm:text-base">Phone:</p>
                    <a href="tel:+911234567890" className="text-orange-600 hover:text-orange-700 text-base sm:text-lg font-semibold break-all">
                      +91 123 456 7890
                    </a>
                  </div>
                </div>
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@danka.com" className="text-orange-600 hover:text-orange-700 text-base sm:text-lg font-semibold break-all">
                      info@danka.com
                    </a>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Franchise Enquiries</h2>
              <p className="text-lg text-gray-700 mb-6">
                Dreaming of owning your own Danka outlet?
              </p>
              <p className="text-gray-600 mb-8">
                Fill out our <Link to="/#inquiry" className="text-orange-600 hover:text-orange-700 font-semibold underline">Franchise Enquiry Form</Link> and our team will get back to you within 48 hours.
              </p>
              <Link
                to="/#inquiry"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-lg shadow-lg p-8">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Customer Feedback</h2>
              <p className="text-lg text-gray-700 mb-6">
                We love hearing from our fans!
              </p>
              <p className="text-gray-600 mb-8">
                Got feedback, suggestions, or just want to tell us how much you loved your panipuri? Drop us a message — we read every one.
              </p>
              ...
              <form onSubmit={handleFeedbackSubmit} className="space-y-6">
                {feedbackSubmitted && (
                  <div className="p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold">Thank you for your feedback! We appreciate it.</span>
                    </div>
                  </div>
                )}
                ...
                <div>
                  <label htmlFor="feedbackMessage" className="block text-sm font-semibold text-gray-700 mb-2">
                    Your Message
                  </label>
                  <textarea
                    id="feedbackMessage"
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Collaborations & Partnerships</h2>
              <p className="text-lg text-gray-700 mb-6">
                Looking to collaborate with Danka for events, catering, or brand partnerships? Let's create something flavourful together!
              </p>
              ...
              <form onSubmit={handleCollaborationSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="collabName" className="block text-sm font-semibold text-gray-700 mb-2">
                    Your Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="collabEmail" className="block text-sm font-semibold text-gray-700 mb-2">
                    Your Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="collabCompany" className="block text-sm font-semibold text-gray-700 mb-2">
                ...
                <div>
                  <label htmlFor="collabMessage" className="block text-sm font-semibold text-gray-700 mb-2">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500 to-yellow-500 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-6">Connect With Us Online</h2>
