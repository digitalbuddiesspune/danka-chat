...
const Footer = () => {
  ...
  const handleLinkClick = (e, to) => {
    // If it's a hash link (like #menu), handle it differently
    if (to.startsWith('#')) {
      e.preventDefault()
      ...
      // For regular routes, navigate (ScrollToTop component will handle scrolling)
      e.preventDefault()
      navigate(to)
    }
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-3 mb-4">
              <div className="rounded-2xl flex items-center justify-center ">
                <img src={Logo} alt="Danka Logo" className="w-12 h-12 sm:w-16 sm:h-16" />
              </div>
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-orange-400">
                  Danka
                </h2>
                <p className="text-gray-400 text-sm">For Panipuri & Chaat Lovers</p>
              </div>
            </div>
            
            <p className="text-gray-300 mb-6 leading-relaxed">
              Experience authentic street food flavors with a modern twist. Bringing joy, one panipuri at a time.
            </p>
          ...
          <div className="lg:col-span-4 bg-orange-500/10 backdrop-blur-sm rounded-2xl p-6 border border-orange-500/20">
            ...
            <p className="text-gray-300 mb-4 text-sm leading-relaxed">
              Get the latest news, special offers, and delicious updates delivered to your inbox.
            </p>
            ...
            {subscribed && (
              <div className="mt-3 p-3 bg-orange-500/20 border border-orange-500/30 rounded-xl flex items-center gap-2">
                ...
                <p className="text-orange-400 text-sm font-medium">Successfully subscribed!</p>
              </div>
            )}
          </div>
          ...
          <div className="lg:col-span-3 grid grid-cols-2 gap-8">
            {/* Getting Started */}
            <div>
              <h4 className="text-orange-400 font-bold mb-4 text-sm uppercase tracking-wider">Explore</h4>
            ...
            {/* Legal */}
            <div>
              <h4 className="text-orange-400 font-bold mb-4 text-sm uppercase tracking-wider">Legal</h4>
              <ul className="space-y-2.5">
                {[
